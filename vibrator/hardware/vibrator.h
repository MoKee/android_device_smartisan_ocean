...
typedef struct vibrator_device {
    ...
    int (*vibrator_set_amplitude)(struct vibrator_device* vibradev, unsigned int amplitude);

    int (*vibrator_haptic_feedback)(struct vibrator_device* vibradev, unsigned int effect);
#endif
} vibrator_device_t;
