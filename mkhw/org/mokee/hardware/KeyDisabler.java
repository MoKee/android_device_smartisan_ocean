...
public class KeyDisabler {
    ...
    private static String KEY_ENABLE_PATH = "/proc/touchscreen/key_enable";
    ...
    public static boolean isSupported() {
        return FileUtils.isFileWritable(KEY_ENABLE_PATH);
    }
    ...
    public static boolean isActive() {
        return FileUtils.readOneLine(KEY_ENABLE_PATH).equals("0");
    }
    ...
    public static boolean setActive(boolean state) {
        return FileUtils.writeLine(KEY_ENABLE_PATH, state ? "0" : "1");
    }
